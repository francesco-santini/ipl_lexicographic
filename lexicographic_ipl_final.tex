...
%	it coincides with subset inclusion:
	The obvious partial order is given by subset inclusion, and 
	in fact $\mathcal{P} = \langle 2^V, \subseteq, \cap, V \rangle$
	is an SLM, yet not necessarily a CLM.
\end{example}
...
\begin{definition}[Distributivity]
	...
	whenever $X$ is finite and distributive if the equality holds also whenever X is infinite and the LUBs exist.
\end{definition}
...
\begin{remark}
	...
	The powerset SLM in Example~\ref{ex:powerset} is distributive.
\end{remark}
