...
Such infinite tuples can be used, for example, with infinitely many timed-variables, therefore associated with an infinite stream of preference. An application is represented by the definition of (constraint) automata accepting an infinite data stream as input~\cite{sca}.
