...
\end{abstract}
        \begin{keyword}
        	Residuation theory, Soft constraints, Lexicographic orders. %\sep Bucket Elimination.
        \end{keyword}
    \end{frontmatter}
...
%
The key requirement is the presence of an aggregator operator for combining preferences, making their set a monoid: a large body 
...
soft concurrent constraint programming,  where a process may be ``telling'' and ``asking'' constraints to a centralised store~\cite{labelled}. 
